...
public class Jogo {
	...
	public boolean jogar() {
		if (ganhou() == 0) {
			System.out.println("--------------------");
			System.out.println("\nRodada " + rodada);
			System.out.println("É vez do jogador " + vez());
			...
			if (tabuleiro.isTabuleiroCheio()) {
				System.out.println("Tabuleiro cheio. Jogo empatado");
				return false;
			}
	...
	public int ganhou() {
		if (tabuleiro.verficarLinhas() == 1)
			return 1;
		if (tabuleiro.verficarColunas() == 1)
			return 1;
		if (tabuleiro.verficatDiagonais() == 1)
			return 1;
